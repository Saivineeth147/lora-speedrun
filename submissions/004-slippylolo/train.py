"""Speedrun attempt: BF16 LoRA with baseline-membership best-fit packing.

What's different from record #1:
  1. A 0.75-epoch schedule at 5e-4 with 6 warmup steps (43 updates on the audited
     454-block reference packing; the exact count is seed-dependent).
...
def main():
    ...
    all_fusion = fuse_qwen2_all_projections(transformer)
    ...
    # forwards before save. The adapter has no custom key or loader requirement.
